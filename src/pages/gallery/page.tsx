...
const gallerySchema = [
  ...
  buildBreadcrumbSchema([{ name: "Home", path: "/" }, { name: "Gallery" }]),
];
    ...
    <div className="relative bg-background-50">
      ...
      <main>
        <PageHero
          ...
          image="https://res.cloudinary.com/dnyvkptxb/image/upload/v1786620570/11_avf6o6.jpg"
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                ...
                <button
                  onClick={() => {
                    ...
                    const isOngoing = allGalleryImages[lightboxIndex]?.projectSlug && ongoingSlugs.includes(currentLightboxImage.projectSlug);
                    
                    if (isOngoing) {
                      navigate(`/projects/ongoing/${currentLightboxImage.projectSlug}`);
                    } else if (isUnbuilt) {
...
const residentialSlugs = ["villa-maaya", "villa-nirvaana", "villa-prana", "levitating-house", "kabini-house", "chodha-residence", "arora-house"];
const hospitalitySlugs = ["kaze", "speakeasy", "sanctum", "rubaiyat", "puma-social-club", "tapas-me", "the-open-box", "taj-westend"];
const commercialSlugs = ["sanctuary-office"];
const prefabSlugs = ["zen-den"];
const unbuiltSlugs = ["etv", "etv-embassy-brewery", "ambience", "ambience-park", "mandala", "mandala-resort", "mit", "mit-manipal-university", "taj-yeshwanthpur", "bellevue", "hilton-clinx", "hilton-klinx", "mercara-house"];
const ongoingSlugs = ["botany-rooftop-bar", "karnataka-golf-association", "nagarhole-wilderness-retreat", "vista-do-mar-apartment", "shobhit-penthouse", "anantapur-residence", "eka-site-development", "ekara-resort", "lake-view-apartment", "marina-residence"];