...
export default function Projects() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Projects"
        description="Explore our architectural work across residential, hospitality, commercial, and mixed-use developments. Completed, ongoing, and unbuilt projects by Sanctuary Architects & Designers, Bangalore."
