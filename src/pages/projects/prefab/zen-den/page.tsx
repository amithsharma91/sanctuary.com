  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        description="Zen Den is a revolutionary 160 SQFT prefabricated modular portable structure for terraces, farms, estates, and open landscapes. Designed by Sanctuary Architects & Designers."
