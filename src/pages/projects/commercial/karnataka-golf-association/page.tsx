...
export default function KarnatakaGolfAssociation() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Karnataka Golf Association (KGA) | Ongoing Project | Sanctuary Architects & Designers"
        ...
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/ongoing/karnataka-golf-association"
        schema={[
          ...
          ]),
          {
            ...
            url: "https://www.sanctuaryarch.com/projects/ongoing/karnataka-golf-association",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="py-24 md:py-32 bg-background-100">
          <div className="w-full px-6 md:px-10 lg:px-14 text-center">
            <p className="font-heading text-2xl md:text-3xl lg:text-4xl font-light text-foreground-950 mb-3 leading-[1.2]">
              Let's Create Your Dream Club Space
            </p>
