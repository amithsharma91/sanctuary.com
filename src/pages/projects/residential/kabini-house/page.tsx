      ...
      <PageMeta
        ...
        schema={[
          ...
          ]),
          {
            ...
            url: "https://www.sanctuaryarch.com/projects/residential/kabini-house",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Karnataka</span>
