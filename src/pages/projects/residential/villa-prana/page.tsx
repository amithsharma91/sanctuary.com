...
export default function VillaPrana() {
  ...
  const blueprintImages: LBImage[] = [
    { src: GROUND_FLOOR, alt: "Ground Floor — Villa Praana", category: "Blueprint" },
    { src: FIRST_FLOOR, alt: "First Floor — Villa Praana", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Villa Praana`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Villa Praana — Residential | Sanctuary Architects & Designers"
        description="Villa Praana is a 3900 SQFT home that breathes, set amidst open agricultural fields in Bengaluru Rural. A carefully choreographed sequence of indoor and outdoor experiences by Sanctuary Architects & Designers."
        keywords="Villa Praana, residential architecture, Bengaluru Rural, luxury villa, open-to-sky courtyard, Sanctuary Architects, contemporary design"
        ...
        schema={[
          ...
          ]),
          {
            ...
            url: "https://www.sanctuaryarch.com/projects/residential/villa-prana",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
      ...
      <main>
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={COVER_IMAGE}
              alt="Villa Praana — Bengaluru Rural"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Villa Praana</span>
            </nav>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={GROUND_FLOOR}
                      alt="Ground Floor Plan — Villa Praana"
                ...
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={FIRST_FLOOR}
                      alt="First Floor Plan — Villa Praana"
                      className="w-full h-auto object-contain rounded-md"
                      loading="lazy"
                    />
                  </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Villa Praana`}
