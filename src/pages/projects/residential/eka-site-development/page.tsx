...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093364/57_bj8lbr.jpg";

const MASTER_PLAN = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093356/20230712-MASTERPLAN_UPDATED_habfpt.jpg";
const STREET_SECTION = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093367/street_section_2_qoqhjh.jpg";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093357/62_gbvwl3.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093359/56_j5cfyl.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093365/58_fofang.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093364/57_bj8lbr.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093368/60_rpo3ly.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786093369/59_drempk.jpg",
];
...
export default function EkaSiteDevelopment() {
  ...
  const blueprintImages: LBImage[] = [
    { src: MASTER_PLAN, alt: "Master Plan — EKA SITE DEVELOPMENT", category: "Blueprint" },
    { src: STREET_SECTION, alt: "Street Section — EKA SITE DEVELOPMENT", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — EKA SITE DEVELOPMENT`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="EKA Site Development | Ongoing | Sanctuary Architects"
        description="Explore EKA SITE DEVELOPMENT, an ongoing residential masterplan across 15.6 acres in Bengaluru Rural by Sanctuary Architects & Designers, placing landscape at the forefront of urban living."
        keywords="EKA SITE DEVELOPMENT, ongoing residential project, Bengaluru Rural, 15.6 acres, landscape-first masterplan, Sanctuary Architects"
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/ongoing/eka-site-development"
        schema={[
          buildBreadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "Projects", path: "/projects" },
            { name: "Ongoing Projects", path: "/projects/ongoing" },
            { name: "EKA SITE DEVELOPMENT" },
          ]),
          {
            ...
            name: "EKA SITE DEVELOPMENT",
            description:
              "A residential community where the landscape becomes the foundation of urban living, with architecture and nature evolving as one interconnected system.",
            url: "https://www.sanctuaryarch.com/projects/ongoing/eka-site-development",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
      ...
      <main>
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={COVER_IMAGE}
              alt="EKA SITE DEVELOPMENT — Bengaluru Rural"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <span className="text-background-50">EKA SITE DEVELOPMENT</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">15.6 Acres</span>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  EKA SITE DEVELOPMENT is envisioned as a residential community where the landscape becomes the foundation of urban living.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Rather than treating open spaces as residual areas left between buildings, the masterplan places nature at the forefront, allowing architecture, infrastructure, and landscape to evolve as one interconnected system.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Nestled within rolling hills, dense plantations, and native vegetation, the development responds to its surroundings rather than imposing upon them. The planning preserves visual corridors towards the hills, strengthens the existing ecological character, and creates a neighbourhood where every home enjoys a direct relationship with nature.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The masterplan is organized through a hierarchy of pedestrian-friendly streets, generous green setbacks, and carefully planted avenues that soften the built environment.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Roads are conceived not merely as movement corridors but as shaded public spaces that encourage slower movement, social interaction, and everyday engagement with the landscape.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                ...
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={MASTER_PLAN}
                      alt="Master Plan — EKA SITE DEVELOPMENT"
                      className="w-full h-auto object-contain rounded-md"
                      loading="lazy"
                    />
                  </div>
                  <div className="px-5 pb-5 pt-1 flex items-center justify-between">
                    <span className="font-heading text-base md:text-lg font-light text-foreground-950">Master Plan</span>
                ...
                <div
                  ...
                  tabIndex={0}
                  role="button"
                  aria-label="View Street Section"
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={STREET_SECTION}
                      alt="Street Section — EKA SITE DEVELOPMENT"
                      className="w-full h-auto object-contain rounded-md"
                      loading="lazy"
                    />
                  </div>
                  <div className="px-5 pb-5 pt-1 flex items-center justify-between">
                    <span className="font-heading text-base md:text-lg font-light text-foreground-950">Street Section</span>
                    <span className="text-xs font-body text-secondary-400">Click to expand</span>
                  </div>
                </div>
              </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — EKA SITE DEVELOPMENT`}
