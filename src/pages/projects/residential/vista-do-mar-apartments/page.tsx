...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786098146/187_mmqgzd.png";
...
export default function VistaDoMarApartments() {
  ...
  const blueprintImages: LBImage[] = [
    { src: PLAN_2_4, alt: "2 & 4 Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_9A, alt: "9A Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_8, alt: "8 Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_1_3_5, alt: "1, 3 & 5 Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_7, alt: "7 Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_6, alt: "6 Plan — Vista do Mar Apartments", category: "Blueprint" },
    { src: PLAN_9B, alt: "9B Plan — Vista do Mar Apartments", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Vista do Mar Apartments`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Vista do Mar Apartments | Ongoing Residential Project | Sanctuary Architects & Designers"
        description="Explore Vista do Mar Apartments, an ongoing luxury residential development in Goa featuring premium coastal architecture, expansive residences and panoramic sea-facing living."
        keywords="Vista do Mar Apartments, ongoing residential project, Goa, luxury apartments, coastal architecture, Sanctuary Architects"
        canonicalPath="/projects/residential/vista-do-mar-apartments"
      />
      <Navbar />
      ...
      <main>
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={COVER_IMAGE}
              alt="Vista do Mar Apartments — Goa"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Vista do Mar Apartments</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Vista do Mar Apartments is a boutique luxury residential development conceived to redefine contemporary coastal living through refined architecture, expansive residences, and seamless indoor–outdoor experiences.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                ...
                {blueprintImages.map((bp, idx) => (
                  ...
                  >
                    ...
                    <div className="px-5 pb-5 pt-1 flex items-center justify-between">
                      <span className="font-heading text-sm md:text-base font-light text-foreground-950">{bp.alt.replace(" — Vista do Mar Apartments", "").replace(" Plan", "")}</span>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Vista do Mar Apartments`}
