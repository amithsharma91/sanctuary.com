  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        description="Kabini House, Levitating House, VILLA MAAYA and Villa Nirvaana — luxury residential projects by Sanctuary Architects & Designers. Contemporary villas across India."
        keywords="luxury residential architecture, Kabini House, Levitating House, Villa Maaya, Villa Nirvaana, custom home design India, Sanctuary residential projects"
    ...
    <div ref={ref} className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
      ...
      >
        ...
        <p className="text-sm md:text-base font-body text-secondary-600 leading-relaxed mb-6 max-w-lg mt-4">
          A sprawling 25-acre residential community along the banks of the Kabini River consisting of 35 luxury villas, each enjoying spectacular waterfront views.
        </p>
        <div className="flex flex-wrap gap-4 mb-8">
          <div className="flex items-center gap-2">
            <i className="ri-map-pin-line text-primary-500 text-sm" />
            <span className="text-xs font-body text-secondary-600">Kabini River</span>
          </div>
          <div className="flex items-center gap-2">
            <i className="ri-ruler-line text-primary-500 text-sm" />
            <span className="text-xs font-body text-secondary-600">25 Acre</span>
          </div>
        </div>
        <button
    ...
    <div ref={ref} className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <div className="flex items-center gap-2">
            <i className="ri-map-pin-line text-primary-500 text-sm" />
            <span className="text-xs font-body text-secondary-600">Goa</span>
          </div>
          <div className="flex items-center gap-2">
            <i className="ri-ruler-line text-primary-500 text-sm" />
            <span className="text-xs font-body text-secondary-600">3530 SQFT</span>
          </div>
        </div>
        <button
          onClick={onViewProject}
