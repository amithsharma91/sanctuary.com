...
export default function Marina() {
  ...
  const blueprintImages: LBImage[] = [
    { src: GROUND_FLOOR, alt: "Ground Floor Plan — Marina", category: "Blueprint" },
    { src: FIRST_FLOOR, alt: "First Floor Plan — Marina", category: "Blueprint" },
    { src: TERRACE_FLOOR, alt: "Terrace Floor Plan — Marina", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Marina`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Marina | Ongoing Residential Project | Sanctuary Architects & Designers"
        description="Explore Marina, an ongoing luxury residential project at Nandi Hills by Sanctuary Architects & Designers, showcasing contemporary architecture, open planning and seamless landscape integration."
        keywords="Marina, ongoing residential project, Nandi Hills, luxury villa, contemporary architecture, Sanctuary Architects, Bengaluru"
        canonicalPath="/projects/residential/marina"
      />
      <Navbar />
      ...
      <main>
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={COVER_IMAGE}
              alt="Marina — Nandi Hills, Bengaluru"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Marina</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Marina Residence is envisioned as a contemporary villa where architecture, landscape, and lifestyle merge into a single living experience.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
