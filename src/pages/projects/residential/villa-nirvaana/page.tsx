  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        description="Villa Nirvaana is a serene 3530 SQFT retreat where architecture and landscape merge into one continuous experience. Designed by Sanctuary Architects & Designers."
