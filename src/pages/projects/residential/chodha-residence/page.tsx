...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786009482/COVER_PHOTO_suxhry.png";
...
const GALLERY_IMAGES = [
  ...
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786009472/CHODHA_RESIDENCE_qwxhtp.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786009645/05_injexj.png",
];
...
export default function ChodhaResidence() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Chodha Residence`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Chodha Residence — Residential | Sanctuary Architects & Designers"
        description="Chodha Residence is a 6000 SQFT contemporary family home in Bangalore. Designed for the architect's joint family with open courtyards, skylights, and abundant natural light by Sanctuary Architects & Designers."
        keywords="Chodha Residence, residential architecture, Bangalore, contemporary family home, courtyards, skylights, Sanctuary Architects"
        canonicalPath="/projects/residential/chodha-residence"
        schema={[
          ...
          ]),
          {
            ...
            name: "Chodha Residence",
            description:
              "A contemporary family residence where traditional Indian living meets modern architecture through open courtyards, skylights, and abundant natural light.",
            url: "https://www.sanctuaryarch.com/projects/residential/chodha-residence",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
      ...
      <main>
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={COVER_IMAGE}
              alt="Chodha Residence — Bangalore"
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Chodha Residence</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Bangalore</span>
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">6000 SQFT</span>
            </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Chodha Residence`}
