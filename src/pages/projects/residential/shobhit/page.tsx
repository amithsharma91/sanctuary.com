...
export default function Shobhit() {
  ...
  const blueprintImages: LBImage[] = [
    { src: GROUND_FLOOR, alt: "Ground Floor Plan — Shobhit Penthouse", category: "Blueprint" },
    { src: FIRST_FLOOR, alt: "First Floor Plan — Shobhit Penthouse", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Shobhit Penthouse`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Shobhit Penthouse | Ongoing | Sanctuary Architects"
        description="Explore Shobhit Penthouse, an ongoing luxury residential penthouse in Goa by Sanctuary Architects & Designers, celebrating tropical contemporary architecture and refined living."
        keywords="Shobhit Penthouse, ongoing residential project, Goa, luxury penthouse, tropical contemporary architecture, Sanctuary Architects"
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/ongoing/shobhit-penthouse"
        schema={[
          buildBreadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "Projects", path: "/projects" },
            { name: "Ongoing Projects", path: "/projects/ongoing" },
            { name: "Shobhit Penthouse" },
          ]),
          {
            ...
            url: "https://www.sanctuaryarch.com/projects/ongoing/shobhit-penthouse",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <span className="text-background-50">Shobhit Penthouse</span>
            </nav>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-2xl mx-auto">
                ...
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={GROUND_FLOOR}
                      alt="Ground Floor Plan — Shobhit Penthouse"
                ...
                >
                  <div className="p-4 md:p-5">
                    <img
                      src={FIRST_FLOOR}
                      alt="First Floor Plan — Shobhit Penthouse"
                      className="w-full h-auto object-contain rounded-md"
                      loading="lazy"
                    />
                  </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Shobhit Penthouse`}
