  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        description="Levitating House is a tropical contemporary villa in Assagao, North Goa. A 4500 SQFT residence blending contemporary architecture with Goan tradition, designed by Sanctuary Architects & Designers."
        keywords="Levitating House, residential architecture, Assagao, North Goa, luxury villa, Sanctuary Architects, tropical contemporary design"
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Assagao, North Goa</span>
