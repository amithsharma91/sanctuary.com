...
export default function HiltonClinx() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Hilton Clinx`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Hilton Clinx | Unbuilt Project | Sanctuary Architects & Designers"
        description="Explore Hilton Clinx, an unbuilt hospitality project by Sanctuary Architects & Designers crafting a serene, highly refined sanctuary with understated tactile warmth and intuitively fluid spatial journey."
        keywords="Hilton Clinx, unbuilt hospitality project, luxury lounge design, refined sanctuary, ambient hospitality interiors, Sanctuary Architects"
        canonicalPath="/projects/unbuilt/hilton-clinx"
      />
      <Navbar />
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Hilton Clinx</span>
            </nav>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Hilton Clinx`}
