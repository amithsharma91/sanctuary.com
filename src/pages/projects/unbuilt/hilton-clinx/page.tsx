...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105322/COVER_PHOTO_gjylnk.jpg";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105298/117_Interactive_LightMix0000_zf94rq.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105299/119_Interactive_LightMix0000_vpz4f5.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105300/113_Interactive_LightMix0000_jsn1i4.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105315/112_Interactive_LightMix0000_rgzcf2.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105320/118_Interactive_LightMix0000_grhvcv.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105322/COVER_PHOTO_gjylnk.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105322/114_Interactive_LightMix0000_kkxrcj.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786105323/115_Interactive_LightMix0000_klsw3e.jpg",
];
...
export default function HiltonClinx() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Hilton Klinx`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Hilton Klinx | Unbuilt Project | Sanctuary Architects & Designers"
        description="Explore Hilton Klinx, an unbuilt hospitality project by Sanctuary Architects & Designers crafting a serene, highly refined sanctuary with understated tactile warmth and intuitively fluid spatial journey."
        keywords="Hilton Klinx, unbuilt hospitality project, luxury lounge design, refined sanctuary, ambient hospitality interiors, Sanctuary Architects"
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/unbuilt/hilton-klinx"
        schema={[
          ...
          ]),
          {
            ...
            name: "Hilton Klinx",
            description:
              "An effortless transition from the everyday to a serene, highly refined sanctuary — where soft ambient light plays across natural plaster and subtle wood textures.",
            url: "https://www.sanctuaryarch.com/projects/unbuilt/hilton-klinx",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Hilton Klinx</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The space is crafted to offer guests an effortless transition from the everyday to a serene, highly refined sanctuary.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  From the moment of arrival, the space greets visitors with an understated tactile warmth, as soft, ambient light plays across natural plaster and subtle wood textures.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The spatial journey is designed to be intuitively fluid — allowing guests to naturally migrate from the vibrant, glowing energy of the bar to the quiet intimacy of plush lounge nooks or shared gathering areas.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Hilton Klinx`}
