...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102624/COVER_PHOTO_poahpz.jpg";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102678/04_2_vh6ngo.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102675/02_Interactive_LightMix_cw1qoe.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102662/05_2_stzagg.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102658/19_qcbrit.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102638/04_1_kwarsn.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102624/COVER_PHOTO_poahpz.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102602/08_1_zm1qnz.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786102593/03_3_ftcll2.jpg",
];
...
export default function Ambience() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Ambience`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/unbuilt/ambience-park"
        schema={[
          ...
          ]),
          {
            ...
            name: "Ambience Park",
            description:
              "A modern, multi-functional community clubhouse integrating Japandi and Warm Minimalist aesthetics across wellness, recreation, and dining zones.",
            url: "https://www.sanctuaryarch.com/projects/unbuilt/ambience-park",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Ambience Park</span>
            </nav>

            <div className="flex flex-wrap items-center gap-3 mb-4">
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Community</span>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Designed as a modern, multi-functional community clubhouse, Ambience Park seamlessly integrates Japandi and Warm Minimalist aesthetics across its wellness, recreation, and dining zones.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The design emphasizes fluid movement, tactile earth tones, and organic forms to create a soothing yet vibrant sanctuary for residents.
                </p>
              </div>
            </div>
          </div>
