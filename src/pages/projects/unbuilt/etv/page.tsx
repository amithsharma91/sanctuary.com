...
export default function ETV() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="ETV | Unbuilt Project | Sanctuary Architects & Designers"
        description="Explore ETV, an unbuilt brewery project by Sanctuary Architects & Designers blending tropical garden aesthetics with warm, organic architectural forms."
        keywords="ETV brewery, unbuilt hospitality project, biophilic architecture, timber canopy design, Sanctuary Architects"
        canonicalPath="/projects/unbuilt/etv"
      />
      <Navbar />
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">ETV</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Designed as an expansive, open-air biophilic oasis, ETV Brewery blends tropical garden aesthetics with warm, organic architectural forms.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
