...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103109/COVER_PHOTO_rxtzlh.jpg";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103008/28_Interactive_LightMix0000_dhbh1o.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103025/29_Interactive_LightMix0000_bksv9n.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103031/25_yx6u8l.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103032/21_ikw2hb.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103034/24_kvmyhl.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103035/31_Interactive_LightMix0000_zf27zh.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786103109/COVER_PHOTO_rxtzlh.jpg",
];
...
export default function ETV() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — ETV Embassy Brewery`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="ETV Embassy Brewery | Unbuilt Project | Sanctuary Architects & Designers"
        description="Explore ETV Embassy Brewery, an unbuilt brewery project by Sanctuary Architects & Designers blending tropical garden aesthetics with warm, organic architectural forms."
        keywords="ETV Embassy Brewery brewery, unbuilt hospitality project, biophilic architecture, timber canopy design, Sanctuary Architects"
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/unbuilt/etv-embassy-brewery"
        schema={[
          buildBreadcrumbSchema([
            { name: "Home", path: "/" },
            { name: "Projects", path: "/projects" },
            { name: "Unbuilt Projects", path: "/projects/unbuilt" },
            { name: "ETV Embassy Brewery" },
          ]),
          {
            ...
            name: "ETV Embassy Brewery",
            description:
              "An expansive, open-air biophilic oasis blending tropical garden aesthetics with warm, organic architectural forms.",
            url: "https://www.sanctuaryarch.com/projects/unbuilt/etv-embassy-brewery",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">ETV Embassy Brewery</span>
            </nav>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Designed as an expansive, open-air biophilic oasis, ETV Embassy Brewery Brewery blends tropical garden aesthetics with warm, organic architectural forms.
                </p>
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The design centers on a multi-layered outdoor layout under a striking network of timber tree-canopies with lattice shading, casting dappled natural light across diverse seating zones.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — ETV Embassy Brewery`}
