...
export default function Mandala() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Mandala Resort`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Mandala Resort | Unbuilt Project | Sanctuary Architects & Designers"
        description="Explore Mandala Resort, an unbuilt eco-luxury wellness sanctuary by Sanctuary Architects & Designers rooted in organic forms, parametric bamboo structures, and earth architecture."
        keywords="Mandala Resort wellness sanctuary, unbuilt eco-luxury project, parametric bamboo architecture, earth architecture, Sanctuary Architects"
        ogImage={COVER_IMAGE}
        canonicalPath="/projects/unbuilt/mandala-resort"
        schema={[
          ...
          ]),
          {
            ...
            url: "https://www.sanctuaryarch.com/projects/unbuilt/mandala-resort",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em] flex-wrap">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Mandala Resort</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Mysuru</span>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Mandala Resort`}
