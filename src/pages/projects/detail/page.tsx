...
export default function ProjectDetail() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title={`${projectTitle} — ${project.category} | Sanctuary Architects & Designers`}
        description={`${project.shortDescription} ${project.location}. ${project.category} project by Sanctuary Architects & Designers, completed ${project.year}.`}
