...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043317/Screenshot_2026-08-07_003818_yredbq.png";
...
const GALLERY_IMAGES = [
  ...
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043255/Screenshot_2026-08-07_003556_nkq0iq.png",
...
export default function Sanctum() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Sanctum — Hospitality | Sanctuary Architects & Designers"
        description="Sanctum is an exclusive private members club in Bengaluru's CBD — contemporary architecture with dramatic lighting, sculptural trellis elements, and a glowing Honey Onyx island bar. Designed by Sanctuary Architects & Designers."
        keywords="Sanctum Bangalore, hospitality architecture, private members club design, luxury interiors, Sanctuary hospitality projects"
        canonicalPath="/projects/hospitality/sanctum"
        schema={[
          ...
          ]),
          {
            ...
            name: "Sanctum",
            description:
              "An exclusive private members club in the heart of Bengaluru's CBD — contemporary architecture with dramatic lighting, sculptural elements, and a glowing Honey Onyx island bar.",
            url: "https://www.sanctuaryarch.com/projects/hospitality/sanctum",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Sanctum</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Bengaluru CBD</span>
