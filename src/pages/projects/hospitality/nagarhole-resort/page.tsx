...
export default function NagarholeResort() {
  ...
  const blueprintImages: LBImage[] = [
    { src: MASTER_PLAN, alt: "Master Plan — Nagarhole Resort", category: "Blueprint" },
    { src: JUNGLE_CAT_VILLA, alt: "Jungle Cat Villa — Nagarhole Resort", category: "Blueprint" },
    { src: TIGER_PAW_VILLA, alt: "Tiger Paw Villa — Nagarhole Resort", category: "Blueprint" },
    { src: KERALA_COTTAGE, alt: "Kerala Cottage — Nagarhole Resort", category: "Blueprint" },
  ];

  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Nagarhole Resort`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Nagarhole Resort | Ongoing Hospitality Project | Sanctuary Architects & Designers"
        description="Explore Nagarhole Resort, an ongoing eco-luxury hospitality project by Sanctuary Architects & Designers, thoughtfully integrated into the forests of Nagarhole National Park."
        keywords="Nagarhole Resort, ongoing hospitality project, eco-luxury resort, Nagarhole National Park, sustainable architecture, Sanctuary Architects"
        canonicalPath="/projects/hospitality/nagarhole-resort"
      />
      <Navbar />
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Nagarhole Resort</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">Nagarhole</span>
                ...
                {blueprintImages.map((bp, idx) => (
                  ...
                  >
                    ...
                    <div className="px-5 pb-5 pt-1 flex items-center justify-between">
                      <span className="font-heading text-sm md:text-base font-light text-foreground-950">{bp.alt.replace(" — Nagarhole Resort", "")}</span>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Nagarhole Resort`}
