...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043864/Screenshot_2026-08-07_004640_fmrirs.png";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043852/_57K1282_PD_raw_znsx2d.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043852/_57K1240_PD_raw_t0thu8.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043851/_57K1257_PD_raw_ujs67l.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786043864/Screenshot_2026-08-07_004640_fmrirs.png",
];
...
export default function Tansen() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Tansen — Hospitality | Sanctuary Architects & Designers"
        description="Tansen is a rich, layered restaurant that transforms the dining experience to the era of kings, palaces and royal durbars. Designed by Sanctuary Architects & Designers."
        keywords="Tansen, hospitality architecture, royal restaurant design, luxury dining, Sanctuary hospitality projects"
        canonicalPath="/projects/hospitality/tansen"
      />
      <Navbar />
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Tansen</span>
            </nav>
            ...
            <p className="text-sm md:text-base font-body text-background-200/75 max-w-xl leading-relaxed">
              A restaurant that is rich, layered and transforms the dining experience to the era of kings, palaces and royal durbars — an immersive atmosphere of timeless luxury.
            </p>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  The aim was to create a restaurant that is rich, layered and transforms the dining experience to the era of kings, palaces and royal durbars, creating an immersive atmosphere of timeless luxury.
                </p>
              </div>
            </div>
          </div>
