  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        ...
        description="Rubaiyat is an opulent dining destination that transports guests into a regal Middle Eastern and Indo-Islamic culinary experience. Designed by Sanctuary Architects & Designers."
