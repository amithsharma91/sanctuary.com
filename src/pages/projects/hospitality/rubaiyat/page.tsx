...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786042862/COVER_PHOTO_tmbxcf.jpg";
...
export default function Rubaiyat() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Rubaiyat`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Rubaiyat — Hospitality | Sanctuary Architects & Designers"
        description="Rubaiyat is an opulent dining destination in Hyderabad that transports guests into a regal Middle Eastern and Indo-Islamic culinary experience. Designed by Sanctuary Architects & Designers."
        keywords="Rubaiyat, hospitality architecture, Middle Eastern restaurant design, Indo-Islamic architecture, luxury dining Bengaluru, Sanctuary hospitality projects"
        canonicalPath="/projects/hospitality/rubaiyat"
        schema={[
          ...
          ]),
          {
            ...
            name: "Rubaiyat",
            description:
              "An opulent dining destination transporting guests into a regal Middle Eastern and Indo-Islamic culinary experience through dramatic architectural grandeur.",
            url: "https://www.sanctuaryarch.com/projects/hospitality/rubaiyat",
            image: COVER_IMAGE,
            creator: {
              "@type": "Organization",
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Rubaiyat</span>
            </nav>
