...
export default function Kaze() {
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="KAZÉ — Hospitality | Sanctuary Architects & Designers"
        description="KAZÉ is a contemporary Asian-inspired restobar on the 21st floor of a landmark building in Bangalore's CBD. Designed by Sanctuary Architects & Designers."
        keywords="KAZÉ, hospitality architecture, restobar design, Bangalore CBD, Asian-inspired design, Japanese tea house inspiration, Sanctuary hospitality projects"
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">KAZÉ</span>
            </nav>
