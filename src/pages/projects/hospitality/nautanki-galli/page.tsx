...
const COVER_IMAGE = "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044082/NAUTANKI_GALLI_duuc5j.jpg";

const GALLERY_IMAGES = [
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044082/05_tdeqxh.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044080/01_1_k2v5oe.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044080/04_sj4ega.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044080/03_y1imig.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044079/02_1_j351x6.jpg",
  "https://res.cloudinary.com/dnyvkptxb/image/upload/v1786044082/NAUTANKI_GALLI_duuc5j.jpg",
];
...
export default function NautankiGalli() {
  ...
  const galleryLightboxImages: LBImage[] = GALLERY_IMAGES.map((src, i) => ({
    src,
    alt: `Gallery Image ${i + 1} — Nautanki Galli`,
    category: "Gallery",
  }));
  ...
  return (
    <div className="relative bg-background-50">
      <PageMeta
        title="Nautanki Galli — Hospitality | Sanctuary Architects & Designers"
        description="Nautanki Galli is a journey through the vibrant streets of India — a restaurant celebrating colour, nostalgia and handcrafted character. Designed by Sanctuary Architects & Designers."
        keywords="Nautanki Galli, hospitality architecture, Indian street inspired restaurant, vibrant bazaar design, Sanctuary hospitality projects"
        canonicalPath="/projects/hospitality/nautanki-galli"
      />
      <Navbar />
        ...
        <section className="relative w-full min-h-[70vh] md:min-h-[85vh] flex items-end pb-14 md:pb-20 overflow-hidden">
          ...
          <div className="relative z-10 w-full px-6 md:px-10 lg:px-14">
            <nav className="flex items-center gap-2 mb-6 text-xs font-body tracking-[0.04em]">
              ...
              <i className="ri-arrow-right-s-line text-background-200/40 text-[10px]" />
              <span className="text-background-50">Nautanki Galli</span>
            </nav>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="text-[10px] font-body tracking-[0.15em] uppercase px-3 py-1 rounded-full bg-background-50/15 text-background-200/80 border border-background-50/15">7,500 SQFT</span>
            </div>
            ...
            <p className="text-sm md:text-base font-body text-background-200/75 max-w-xl leading-relaxed">
              Not merely a restaurant but a journey through the vibrant streets of India — celebrating colour, nostalgia and handcrafted character through immersive storytelling.
            </p>
          </div>
        </section>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-6">
                <p className="text-sm md:text-base font-body text-secondary-600 leading-[1.8]">
                  Nautanki Galli is not merely a restaurant but a journey through the vibrant streets of India. Inspired by bustling bazaars, street culture and everyday life, the interiors celebrate colour, nostalgia and handcrafted character through immersive storytelling.
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="columns-1 sm:columns-2 lg:columns-3 gap-4 md:gap-5">
                {GALLERY_IMAGES.map((src, index) => (
                  ...
                  >
                    <img
                      src={src}
                      alt={`Gallery ${index + 1} — Nautanki Galli`}
