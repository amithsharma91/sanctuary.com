...
import Tansen from "../pages/projects/hospitality/tansen/page";
import NautankiGalli from "../pages/projects/hospitality/nautanki-galli/page";
...
const routes: RouteObject[] = [
  ...
  { path: "/projects/residential/marina", element: <Marina /> },
  { path: "/projects/residential/shobhit", element: <Shobhit /> },
  { path: "/projects/residential/vista-do-mar-apartments", element: <VistaDoMarApartments /> },
  { path: "/projects/residential/eka-site-development", element: <EkaSiteDevelopment /> },
  { path: "/projects/hospitality", element: <HospitalityProjects /> },
  { path: "/projects/hospitality/kaze", element: <Kaze /> },
  { path: "/projects/hospitality/tansen", element: <Tansen /> },
  { path: "/projects/hospitality/nautanki-galli", element: <NautankiGalli /> },
  ...
  { path: "/projects/hospitality/nagarhole-resort", element: <NagarholeResort /> },
  { path: "/projects/hospitality/ekara-resort", element: <EkaraResort /> },
  { path: "/projects/commercial", element: <CommercialProjects /> },
  { path: "/projects/commercial/sanctuary-office", element: <SanctuaryOffice /> },
  { path: "/projects/commercial/karnataka-golf-association", element: <KarnatakaGolfAssociation /> },
